...
class IFirestore : AppCompatActivity() {
    ...
    val arreglo: ArrayList<JCities> = arrayListOf()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        botonIndiceCompuesto.setOnClickListener { consutlarIndiceCompuesto(adaptador) }
    ...
    fun crearEjemplo(){
        ...
        val refereciaEjemploEstudiante = db
            .collection("ejemplo")
        //.document("id_hijo")
        ...
        refereciaEjemploEstudiante
            .document("12345678")
            .set(datosEstudiante)
            .addOnSuccessListener {}
            .addOnFailureListener{}

        //identificador quemado para autofenerado con Date().time
    ...
    fun consutlarIndiceCompuesto(adaptador: ArrayAdapter<JCities>){
        val db = Firebase.firestore
    ...
    fun consultarConOrderBy(adaptador: ArrayAdapter<JCities>){
        val db = Firebase.firestore
        val citiesRefUnico = db.collection("cities")
        limpiarArreglo()
        adaptador.notifyDataSetChanged()
    ...
    fun consultarDocumento(
        adaptador: ArrayAdapter<JCities>
    ){
        val db = Firebase.firestore
        val citiesRefUnico = db.collection("cities")
        limpiarArreglo()
